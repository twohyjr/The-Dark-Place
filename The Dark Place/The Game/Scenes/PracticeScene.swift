...
class PracticeScene: Scene {
    ...
    private func addTerrain(){
        ...
        terrain = Terrain(gridSize: worldData.itemData.width, cellsWide: worldData.terrainData.width, cellsBack: worldData.terrainData.depth, textureType: .CartoonGrass)
        terrain.diffuse = 1.5
        addChild(terrain)
    }
